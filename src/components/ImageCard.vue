<template>
	<div class="card" :class="cardClass">
		...
		<footer class="px-6 py-2 flex flex-row flex-wrap">
			<a v-for="hashtag in cardHashs" :href="hashtag.href" class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2" :class="hashtag.class">
